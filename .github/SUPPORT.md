# Getting help with MiST

Thanks for using MiST. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/MiST/issues) to make sure the 
